...
$sql = "SELECT * FROM Reserva WHERE res_id = ? AND res_host_id = ?";
...
<form action="" method="POST">
    ...
    <input type="date" name="data_inicio" value="<?php echo substr($reserva["res_inicio"], 0, 10); ?>" required>

    <br><br>

    <label>Data fim</label>

    <input type="date" name="data_fim" value="<?php echo substr($reserva["res_fim"], 0, 10); ?>" required>
